...
const StationaryPage = () => {
  return (
    <section className='pt-[11rem] flex flex-col items-center w-full mx-0 px-0'>
        <div className='h-0 border-x-[20rem] border-b-[3rem] border-transparent border-b-red-200 rotate-180 m-0'></div>
