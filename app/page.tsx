...
export default function Home() {
  return (
    <section className="pt-[11rem] flex flex-col items-center z-1">
      <h1 className="text-xl font-bold">Home Page</h1>
      <div className='bg-[#000dff] min-w-[40rem] w-[70%] aspect-[40/14] rounded-lg my-6 text-white'>
        <p className="relative top-1/4 left-[20%]
        text-lg md:text-xl lg:text-2xl">
          The exquisite collection
          <br/>
          by <strong className="font-serif text-yellow-400">Gianni Versace</strong>
        </p>
        <p className="relative top-[30%] left-[22%]
